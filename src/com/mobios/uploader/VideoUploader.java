...
public class VideoUploader extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request,
        ...
        String img_tag = request.getParameter("vidTag");
        ...
        for (Part part : request.getParts()) {
            if (part.getName().equals("video")) {
                fileName = getFileName(part);
                part.write(uploadFilePath + File.separator +img_tag+formatDate+".mp4");
            }
        }


        String s = "https://viber.textware.lk/viberastro/testdemo/news" +File.separator+ img_tag + formatDate+".mp4";
        //String s ="sds";
    ...
    private String getFileName(Part part) {
        ...
        for (String token : tokens) {
            if (token.trim().startsWith("video")) {
