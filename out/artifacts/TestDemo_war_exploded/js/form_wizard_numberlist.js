...
var FormWizard = function() {
    ...
    var _componentWizard = function() {
        ...
        $('.steps-validation').steps({
            ...
            titleTemplate: '<span class="number">#index#</span> #title#',
            labels: {
                previous: `<i class="icon-arrow-left13 mr-2" /><span style="font-family: 'Poppins',sans-serif;"> PREVIOUS</span>`,
                next: `<span style="font-family: 'Poppins',sans-serif;">NEXT</span><i class="icon-arrow-right14 ml-2" />`,
                finish: `<span style="font-family: 'Poppins',sans-serif;">FINISH</span><i class="icon-arrow-right14 ml-2" />`
            },
            transitionEffect: 'fade',
            autoFocus: true,
