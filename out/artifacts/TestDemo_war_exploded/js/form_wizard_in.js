...
var FormWizard = function () {
    ...
    var _componentWizard = function () {
        ...
        $('.steps-async').steps({
            ...
            onFinished: function (event, currentIndex) {
                alert('Form submittedaaaaaaaaaaaaaaaaaaaaaaaa.');
            }
        });
        ...
        $('.steps-state-saving').steps({
            ...
            autoFocus: true,
            onFinished: function (event, currentIndex) {
                alert('Form submittedxxxxxxxxxxxxxxxxxxxxxxx.');
            }
        });
        ...
        $('.steps-starting-step').steps({
            ...
            autoFocus: true,
            onFinished: function (event, currentIndex) {
                alert('Form submittedsssssssssssssssssssssssss.');
            }
        });
        ...
        $('.steps-validation').steps({
            ...
            titleTemplate: '<span class="number">#index#</span> #title#',
            labels: {
                previous: '<i class="icon-arrow-left13 mr-2" id="preBtn" /> Previous',
                next: 'Next <i class="icon-arrow-right14 ml-2" />',
                finish: 'Submit form <i id="subBtn" class="icon-arrow-right14 ml-2" />'
            },
            transitionEffect: 'fade',
            autoFocus: true,
