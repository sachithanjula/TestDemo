            ...
            onStepChanging: function (event, currentIndex, newIndex) {
                ...
                if (currentIndex < newIndex) {
                    ...
                    if (newIndex == 1) {
                        ...
                        if (mediumtype == 'sms') {
                            window.location.replace("composeSMS.jsp?type=sms");
                        } else if (mediumtype == 'viber') {
                            window.location.replace("composeMessage.jsp?type=viber");
                        } else if (mediumtype == 'whatsapp') {
                            window.location.replace("composeWhatsapp.jsp?type=whatsapp");
                        }
