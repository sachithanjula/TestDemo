...
if (!window['google']['loader']) {
    ...
    google.loader.ServiceBase = 'assets/js/trans.js';
    ...
    (function () {
        var h = this || self, aa = /^[\w+/_-]+[=]{0,2}$/, l = null, m = function (a, b, c) {
            a = a.split(".");
            c = c || h;
        ...
        (new p).c("");
        var q = /&/g, r = /</g, t = />/g, u = /"/g, v = /'/g, w = /\x00/g, ba = /[\x00&<>"']/;
        var x = function () {
            this.O = ""
        };
        ...
        Q.prototype.load = function (a, b) {
            var c = this.I(b), d = b && null != b.callback;
        ...
        R.prototype.ba = function (a, b, c) {
            ...
            if (null != c) for (var e in c) a.params[e] ? d += "&" + U(a.params[e], c[e]) : "other_params" == e ? d += "&" + c[e] : "base_domain" == e && (b = "https://" + c[e] + a.uri.substring(a.uri.indexOf("/", 7)));
            google[this.name] = {};
        ...
        R.prototype.J = function (a) {
            if (this.A) for (var b = 0; b < this.A.length; ++b) {
                var c = this.A[b];
        ...
        var V = !1, W = [], ea = (new Date).getTime(), Y = function () {
    ...
    google.loader.rfm({
        ":search": {
            "versions": {":1": "1", ":1.0": "1"},
            "path": "/api/search/1.0/c0497eba726ac5bee594830508847206/",
            "js": "default+en.I.js",
            "css": "default+en.css",
            "properties": {":Version": "1.0", ":NoOldNames": false, ":JSHash": "c0497eba726ac5bee594830508847206"}
        },
        ":language": {
            "versions": {":1": "1", ":1.0": "1"},
            "path": "/api/language/1.0/69e2d4143fb2e4de590e5266894c5155/",
            "js": "default+en.I.js",
            "properties": {":Version": "1.0", ":JSHash": "69e2d4143fb2e4de590e5266894c5155"}
        },
        ":annotations": {
            "versions": {":1": "1", ":1.0": "1"},
        ...
        ":ads": {
            ...
            "js": "default.I.js",
            "properties": {":Version": "3.0", ":JSHash": "551e6924d0b905f28dbc421713da34db"}
        },
        ":picker": {
            "versions": {":1": "1", ":1.0": "1"},
