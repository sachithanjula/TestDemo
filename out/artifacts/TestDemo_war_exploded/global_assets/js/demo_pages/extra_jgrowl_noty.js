...
//        });
        ...
        //video not uploaded
        $('#not_uploaded').on('click', function () {
            new Noty({
                theme: ' alert bg-danger text-white alert-styled-left p-0',
                text: 'Please upload the video before submitting !',
                type: 'error',
                progressBar: false,
                closeWith: ['&times;'],
                layout: 'bottomRight',
        ...
        //invalid link
        $('#invalid_upload_link').on('click', function () {
            new Noty({
                theme: ' alert bg-danger text-white alert-styled-left p-0',
                text: 'Please enter a valid upload link !',
                type: 'error',
                progressBar: false,
                closeWith: ['&times;'],
                layout: 'bottomRight',
        ...
        // Solid styled
        $('#saved_success').on('click', function (param) {
            new Noty({
                theme: ' alert bg-success text-white alert-styled-left p-0',
                text: 'Saved successfully ! ' + param,
                type: 'success',
                progressBar: false,
                closeWith: ['&times;'],
                layout: 'bottomRight'
        ...
        // login failed
        $('#login_failed').on('click', function () {
            new Noty({
                theme: ' alert bg-danger text-white alert-styled-left p-0',
                text: 'Login failed !',
                type: 'error',
        ...
        // save failed
        $('#saved_failed').on('click', function () {
            new Noty({
                theme: ' alert bg-danger text-white alert-styled-left p-0',
                text: 'Save failed !',
                type: 'error',
        ...
        // updated failed
        $('#update_failed').on('click', function () {
            new Noty({
                theme: ' alert bg-danger text-white alert-styled-left p-0',
                text: 'Update failed !',
                type: 'error',
        ...
        //assigned successfull
        $('#noty_solid_assigned').on('click', function () {
            new Noty({
                theme: ' alert bg-success text-white alert-styled-left p-0',
        ...
        // assign failed
        $('#noty_solid_assign_failed').on('click', function () {
            new Noty({
                theme: ' alert bg-danger text-white alert-styled-left p-0',
                text: 'Assign failed !',
                type: 'error',
        ...
        // unassign successfull
        $('#noty_solid_unassigned').on('click', function () {
            new Noty({
                theme: ' alert bg-success text-white alert-styled-left p-0',
        ...
        // unassign failed
        $('#noty_solid_unassign_failed').on('click', function () {
            new Noty({
                theme: ' alert bg-danger text-white alert-styled-left p-0',
                text: 'Unassign failed !',
                type: 'error',
                progressBar: false,
                closeWith: ['&times;'],
                layout: 'bottomRight'
