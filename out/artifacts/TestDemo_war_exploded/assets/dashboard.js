...
var Dashboard = function () {
    ...
    var _MarketingCampaignsDonutChart = function(element, size, values, names) {
        if (typeof d3 == 'undefined') {
            console.warn('Warning - d3.min.js is not loaded.');
            return;
        }
            ...
            var tip = d3.tip()
                ...
                .html(function (d) {
                    return '<ul class="list-unstyled mb-1">' +
                        ...
                        '<li>' + 'Count: &nbsp;' + '<span class="font-weight-semibold float-right">' + d.value + '</span>' + '</li>' +
    ...
    return {
        ...
        initCharts: function() {
            ...
            // _RoundedProgressChart('#hours-available-progress', 38, 2, '#4CAF50', 0.68, 'icon-shield-check text-success', 'Success', '52');
            // _RoundedProgressChart('#goal-progress', 38, 2, '#f44336', 0.05, 'icon-shield-notice text-danger', 'Fail', '5');
            //_RoundedProgressChart('#hours-available-progress1', 38, 2, '#777777', 0.01, 'icon-notification2 text-grey', 'Time Out', '5');

            // Donut charts
            //_MarketingCampaignsDonutChart('#campaigns-donut', 100);
            ...
            //  _BarChart('#hours-available-bars1', 24, 40, true, 'elastic', 1200, 50, '#777777', 'hours' , barData);
            //   _BarChart('#goal-bars', 24, 40, true, 'elastic', 1200, 50, '#f44336', 'hours' , barData);
            // _BarChart('#members-online', 24, 50, true, 'elastic', 1200, 50, 'rgba(255,255,255,0.5)', 'members', barData);
        ...
        MarketingCampaignsDonutChart:function(element, values, names){
            _MarketingCampaignsDonutChart(element, 120, values, names);
        }
    }
}();
...
function ShowMarketingCampaignsDonutChart(element, values, names){
    Dashboard.MarketingCampaignsDonutChart(element, values, names);
}
